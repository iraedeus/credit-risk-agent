...
class TestStandardScaler:
    def test_fit_computes_correct_mean_and_std(self) -> None:
        """Verify fit computes correct mean and std for target columns."""
        # Arrange
    ...
    def test_transform_normalizes_data_correctly(self) -> None:
    ...
    def test_fit_zero_std_handling(self) -> None:
        """Verify that constant features with zero std default std to 1.0 to prevent zero division."""
        # Arrange
    ...
    def test_transform_non_inplace_safety(self) -> None:
        """Verify that transform returns a new DataFrame without modifying the input slice."""
        # Arrange
    ...
    def test_transform_missing_columns_raises_value_error(self) -> None:
        """Verify ValueError is raised when transforming a column absent from scaler parameters."""
        # Arrange
